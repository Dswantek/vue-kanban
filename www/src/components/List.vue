<template>
    <div class="panel panel-warning" droppable="true" v-on:drop.capture="updateTask" ondragover="event.preventDefault()">
    ...
    export default {
        ...
        methods: {
            ...
            updateTask(event) {
                ...
                console.log(task)
                this.$store.dispatch('updateTask', { boardId: this.task.boardId, task: task, listId: this.listprop._id})
            }
